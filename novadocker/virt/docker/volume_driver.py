...
class DockerVolumeDriver(VolumeDriver):
    ...
    def attach_volume(self, connection_info, instance, mountpoint):
        ...
        self._publish_iscsi(instance, mountpoint, host_ip,
                            conf.source_path)
        self._login_iscsi(mountpoint, disk_info)
    ...
    # on the host.
    def _login_iscsi(self, connection_info, disk_info):
        """Attach the volume to instance_name."""

        print "In login_iscsi, iscsi connection_info is", connection_info
        iscsi_properties = connection_info['data']
        print "iscsi_properties", iscsi_properties
