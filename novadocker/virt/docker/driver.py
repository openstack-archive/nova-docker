...
class DockerDriver(driver.ComputeDriver):
    ...
    def plug_vifs(self, instance, network_info):
        ...
        # NOTE(arosen): docker automatically adds an eth0 interface
        # to each container with an autogenerated ip that it picks. We
        # don't want this so we remove this interface. This call
        # can return an exit code of 1 in the cases where eth0 has
        # already been removed which occurs when nova-compute is restarted
        # and nova wants to replug all the vifs.
