...
class DockerHTTPClient(object):
    ...
    def device_add(self, container_id, device):
        LOG.debug("device_add called with container id %s and device %s" % (container_id, device))
    ...
    def device_remove(self, container_id, device):
        LOG.debug("device_remove called with container id %s and device %s" % (container_id, device))
